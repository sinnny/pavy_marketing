        ...
        >
          <div className="max-w-5xl mx-auto bg-white/90 backdrop-blur-xl rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-white/20 p-6 md:p-8 overflow-hidden relative">
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-8 md:gap-12">
              <div className="bg-indigo-600 p-4 rounded-2xl shrink-0 hidden md:block shadow-lg shadow-indigo-200">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-xl font-bold text-slate-900 mb-2 flex items-center justify-center md:justify-start gap-2">
                  <Cookie className="w-5 h-5 text-indigo-600 md:hidden" />
                  {t('pages.legal.cookieBanner.title')}
                </h3>
                <p className="text-slate-600 leading-relaxed max-w-2xl">
                  {t('pages.legal.cookieBanner.description')}
                  <Link to={localePath('/legal/privacy')} className="text-indigo-600 font-bold hover:underline">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3 rounded-full text-sm font-bold text-slate-600 hover:bg-slate-100 transition-all active:scale-95"
                >
                  {t('pages.legal.cookieBanner.manage')}
                </button>
                <button
                  onClick={rejectAll}
                  className="w-full sm:w-auto px-6 py-3 rounded-full text-sm font-bold border border-slate-200 text-slate-700 hover:bg-slate-50 transition-all active:scale-95"
                >
                  {t('pages.legal.cookieBanner.rejectAll')}
                </button>
                <button
                  onClick={acceptAll}
                  className="w-full sm:w-auto px-8 py-3 rounded-full text-sm font-bold bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all active:scale-95"
                >
