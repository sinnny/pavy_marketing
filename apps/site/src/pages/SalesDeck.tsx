    ...
    content: (
      <div className="flex flex-col lg:flex-row items-center justify-center h-full max-w-7xl mx-auto px-6 gap-8 lg:gap-24">
        <div className="flex-1 w-full relative z-10 flex flex-col justify-center">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-3 sm:mb-6 block whitespace-nowrap">
            01 / Introduction
          </span>
    ...
    content: (
      <div className="flex flex-col lg:flex-row items-center h-full max-w-7xl mx-auto px-6 gap-8 lg:gap-24">
        <div className="flex-1 w-full relative z-10">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-2 sm:mb-6 block whitespace-nowrap">
            02 / The Problem
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 leading-tight mb-4 sm:mb-8 break-keep">
            <span className="whitespace-nowrap">고객은 기다리지 않습니다.</span>
            <br />
        ...
        <div className="flex-1 bg-white p-6 lg:p-10 rounded-[20px] lg:rounded-[32px] shadow-2xl shadow-slate-200 border border-slate-100 flex flex-col items-center gap-6 lg:gap-8 w-full max-w-md mx-auto relative z-10 mt-6 lg:mt-0">
          <div className="w-full bg-slate-50 p-4 lg:p-6 rounded-2xl flex items-center justify-between border border-slate-100">
            ...
            <span className="text-2xl lg:text-3xl font-black text-slate-400 whitespace-nowrap">
              10분+
            </span>
          </div>
          ...
          <div className="w-full bg-indigo-50 p-4 lg:p-6 rounded-2xl flex items-center justify-between border border-indigo-100">
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <span className="text-base lg:text-xl font-bold text-indigo-900 whitespace-nowrap">
                Pavy.ai 도입 시
              </span>
            </div>
            <span className="text-3xl lg:text-4xl font-black text-indigo-600 whitespace-nowrap">
              3초
            </span>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col h-full max-w-6xl mx-auto px-6 justify-center">
        <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-3 sm:mb-6 block text-center whitespace-nowrap">
          03 / The Solution
        </span>
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col lg:flex-row items-center h-full max-w-6xl mx-auto px-6 gap-8 lg:gap-16">
        <div className="flex-1 w-full relative z-10">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-400 mb-2 sm:mb-6 block whitespace-nowrap">
            04 / Trust & Safety
          </span>
      ...
      <div className="flex flex-col lg:flex-row items-center h-full max-w-6xl mx-auto px-6 gap-8 lg:gap-16">
        ...
        <div className="flex-1 w-full flex flex-col items-center gap-4 lg:gap-6 mt-8 lg:mt-0 relative z-10">
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-slate-100 p-4 lg:p-6 flex items-center gap-4 lg:gap-6 transform hover:-translate-y-1 transition-transform">
            ...
            <div>
              <div className="font-bold text-slate-900 text-sm lg:text-lg mb-1 whitespace-nowrap">
                여성 패션 쇼핑몰
              </div>
              <div className="text-[10px] lg:text-sm whitespace-nowrap bg-rose-50 px-2 lg:px-3 py-1 rounded-full text-rose-600 font-bold inline-block">
                "언니, 이거 좀 핏하게 나왔어요!"
              </div>
            </div>
          </div>
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-slate-100 p-4 lg:p-6 flex items-center gap-4 lg:gap-6 transform lg:-translate-x-6 hover:-translate-y-1 transition-transform">
            ...
            <div>
              ...
              <div className="text-[10px] lg:text-sm whitespace-nowrap bg-blue-50 px-2 lg:px-3 py-1 rounded-full text-blue-600 font-bold inline-block">
  ...
  },
  {
    ...
    content: (
      <div className="flex flex-col h-full max-w-5xl mx-auto px-6 justify-center items-center text-center">
        <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-400 mb-3 sm:mb-6 block whitespace-nowrap">
          08 / Easy Setup
        </span>
...
export default function SalesDeck() {
  ...
  return (
    <div
      className={`fixed inset-0 overflow-hidden transition-colors duration-700 ${slide.theme === "dark" ? "bg-slate-900" : "bg-slate-50"}`}
    >
      ...
      <div className="absolute bottom-8 left-0 w-full px-10 flex items-center justify-between z-50 pointer-events-none">
        <div
          className={`text-sm font-bold tracking-widest ${slide.theme === "dark" ? "text-slate-500" : "text-slate-400"}`}
        >
          PAVY.AI SALES DECK
        </div>
        ...
        <div className="flex items-center gap-4 pointer-events-auto">
          ...
          <div
            className={`font-bold tracking-widest px-4 ${slide.theme === "dark" ? "text-slate-400" : "text-slate-500"}`}
          >
