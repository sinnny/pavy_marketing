...
const slides = [
  {
    ...
    content: (
      <div
        className={`flex flex-col items-center justify-center text-center max-w-5xl mx-auto px-6 ${slideViewportClass}`}
      >
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col lg:flex-row items-center justify-center max-w-7xl mx-auto px-6 gap-8 lg:gap-24 ${slideViewportClass}`}
      >
        <div className="flex-1 w-full relative z-10 flex flex-col justify-center">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-3 sm:mb-6 block sm:whitespace-nowrap">
            01 / Introduction
          </span>
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-4 sm:mb-8 break-keep">
            상세페이지를 읽는 AI,
            <br />
            <span className="text-indigo-600 sm:whitespace-nowrap">
              Pavy.ai란 무엇인가요?
            </span>
          </h2>
          <ul className="space-y-3 sm:space-y-6 text-sm sm:text-lg md:text-xl text-slate-600 break-keep">
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">스스로 상품 공부 완료:</b>{" "}
                스크립트 한 줄이면 쇼핑몰의 상세페이지(PDP)를 AI가 스스로 읽고
                100% 이해합니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">24시간 친절한 점원:</b> 고객이
                묻는 사이즈, 색상, 배송 정보를 잠도 안 자고 가장 정확하게
                안내합니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">매출 수직 상승:</b> 결제를
                망설이는 순간, 즉각적인 답변으로 이탈을 막고 지갑을 열게
                만듭니다.
              </div>
            </li>
          </ul>
        ...
        <div className="flex-1 w-full mt-4 lg:mt-0 max-w-sm lg:max-w-md bg-white border border-slate-200 rounded-[24px] shadow-2xl relative z-10 overflow-hidden hidden sm:flex flex-col">
          ...
          <div className="p-4 bg-slate-50 flex flex-col gap-3 flex-1">
            <div className="bg-white border border-slate-200 text-slate-800 text-xs sm:text-sm p-3 rounded-2xl rounded-tr-sm self-end max-w-[85%] shadow-sm">
              모델분이 입으신 스커트 M사이즈 맞나요?
            </div>
            <div className="bg-indigo-50 text-indigo-900 border border-indigo-100 text-xs sm:text-sm p-3 rounded-2xl rounded-tl-sm self-start max-w-[90%] shadow-sm">
              네! 사진 속 모델분(168cm, 52kg)은 스커트 <b>M사이즈</b>를
              착용하셨습니다. 허리 27 입으시면 M 추천드려요!
            </div>
          </div>
        </div>
      </div>
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col lg:flex-row items-center max-w-7xl mx-auto px-6 gap-8 lg:gap-24 ${slideViewportClass}`}
      >
        <div className="flex-1 w-full relative z-10">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-2 sm:mb-6 block sm:whitespace-nowrap">
            02 / The Problem
          </span>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-slate-900 leading-tight mb-4 sm:mb-8 break-keep">
            <span className="sm:whitespace-nowrap">고객은 기다리지 않습니다.</span>
            <br />
          ...
          <ul className="space-y-3 sm:space-y-6 text-sm sm:text-lg md:text-xl text-slate-600 break-keep">
            <li className="flex gap-2 sm:gap-4 items-start">
              <AlertIcon />
              <div className="leading-snug">
                질문이 있는 고객은 <b>지갑을 열 준비가 된 고객</b>입니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <AlertIcon />
              <div className="leading-snug">
                하지만 기존 게시판이나 톡 상담은 답변을 받기까지 평균{" "}
                <b>10분 이상</b> 걸립니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <AlertIcon />
              <div className="leading-snug">
                기다리는 사이 고객은 다른 곳으로 갑니다. CS 직원을 계속해서
                늘리는 것도 한계가 있죠.
              </div>
            </li>
          </ul>
        ...
        <div className="flex-1 bg-white p-6 lg:p-10 rounded-[20px] lg:rounded-[32px] shadow-2xl shadow-slate-200 border border-slate-100 flex flex-col items-center gap-6 lg:gap-8 w-full max-w-md mx-auto relative z-10 mt-6 lg:mt-0">
          <div className="w-full bg-slate-50 p-4 lg:p-6 rounded-2xl flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border border-slate-100">
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-slate-200 rounded-full flex items-center justify-center shrink-0">
                <Clock className="text-slate-500 w-5 h-5 lg:w-6 lg:h-6" />
              </div>
              <span className="text-base lg:text-xl font-bold">기존 게시판 상담</span>
            </div>
            <span className="text-2xl lg:text-3xl font-black text-slate-400">
              10분+
            </span>
          </div>
          ...
          <div className="w-full bg-indigo-50 p-4 lg:p-6 rounded-2xl flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border border-indigo-100">
            <div className="flex items-center gap-3 lg:gap-4">
              <div className="w-10 h-10 lg:w-12 lg:h-12 bg-indigo-500 rounded-full flex items-center justify-center shrink-0">
                <AIIcon
                  family="wave"
              ...
              <span className="text-base lg:text-xl font-bold text-indigo-900">
                Pavy.ai 도입 시
              </span>
            </div>
            <span className="text-3xl lg:text-4xl font-black text-indigo-600">
              3초
            </span>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col max-w-6xl mx-auto px-6 justify-center ${slideViewportClass}`}
      >
        <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-3 sm:mb-6 block text-center sm:whitespace-nowrap">
          03 / The Solution
        </span>
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col lg:flex-row items-center max-w-6xl mx-auto px-6 gap-8 lg:gap-16 ${slideViewportClass}`}
      >
        <div className="flex-1 w-full relative z-10">
          <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-400 mb-2 sm:mb-6 block sm:whitespace-nowrap">
            04 / Trust & Safety
          </span>
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white leading-tight mb-4 sm:mb-8 break-keep">
            AI가 <span className="text-emerald-400">거짓말</span>을 할까 봐
            <br /> 걱정이신가요?
          </h2>
          <p className="text-sm sm:text-lg md:text-xl text-slate-300 mb-6 sm:mb-8 leading-relaxed break-keep">
            Pavy.ai는 우리 쇼핑몰에 <b>있는 상품 내용으로만</b> 대답하도록
            학습되어 있습니다. 학습되지 않은 내용은 절대 지어내지 않습니다.
          </p>
          <div className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-bold text-[11px] sm:text-sm md:text-base whitespace-normal sm:whitespace-nowrap text-left w-fit">
            <ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" /> 사실 기반
            답변
          </div>
        </div>
        <div className="flex-1 w-full bg-slate-800 p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] border border-slate-700 shadow-2xl relative z-10 mt-6 lg:mt-0 max-w-md mx-auto">
          <div className="flex flex-col gap-3 sm:gap-6">
            ...
            <div className="self-start bg-indigo-600 text-white p-3 sm:p-4 rounded-2xl rounded-tl-sm max-w-[95%] shadow-lg text-xs sm:text-base break-words leading-relaxed">
              죄송합니다만 현재 상품 안내에는 <b>블랙 재입고 일정</b>이
              없습니다. 번거로우시겠지만 Q&A 게시판에 남겨주시면 담당자가
              답변드리겠습니다!
            </div>
            <div className="self-start flex items-center gap-1 sm:gap-2 text-[10px] sm:text-[11px] md:text-xs text-indigo-300 bg-indigo-300/10 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full mt-2">
              <ShieldCheck className="w-3 h-3 sm:w-4 sm:h-4 shrink-0" /> 사실이
              아닌 내용은 솔직히 "모른다"고 응답
            </div>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col max-w-6xl mx-auto px-6 justify-center items-center text-center ${slideViewportClass}`}
      >
        <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-500 mb-3 sm:mb-6 block sm:whitespace-nowrap">
        ...
        <div className="flex-1 order-1 lg:order-2 w-full relative z-10 flex flex-col justify-center">
          ...
          <ul className="space-y-3 sm:space-y-6 text-sm sm:text-lg md:text-xl text-slate-600 break-keep">
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">진짜 관심사 파악:</b> 쇼핑몰
                고객들이 어떤 상품에서 무엇을 망설이는지 한눈에 봅니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">즉각적인 피드백 적용:</b> 자주
                묻는 질문을 바로 상세페이지 썸네일에 추가해 구매율을 올립니다.
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="flex-1 w-full relative z-10 flex flex-col justify-center">
          ...
          <ul className="space-y-4 sm:space-y-6 text-sm sm:text-lg md:text-xl text-slate-600 break-keep">
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">브랜드 컬러 매칭:</b> 베이지,
                스카이 블루 등 쇼핑몰 분위기에 딱 맞는 테마 색상을 직접
                고릅니다.
              </div>
            </li>
            <li className="flex gap-2 sm:gap-4 items-start">
              <CheckCircle2 className="text-indigo-500 shrink-0 mt-0.5 w-5 h-5 sm:w-6 sm:h-6" />
              <div className="leading-snug">
                <b className="text-indigo-600">맞춤형 호칭 & 어투:</b> "고객님"
                대신 "언니!", 딱딱한 존댓말 대신 친절한 말투 등 우리 몰 구조에
                딱 맞춥니다.
              </div>
            </li>
          </ul>
        ...
        <div className="flex-1 w-full flex flex-col items-center gap-4 lg:gap-6 mt-8 lg:mt-0 relative z-10">
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-slate-100 p-4 lg:p-6 flex items-start sm:items-center gap-4 lg:gap-6 transform hover:-translate-y-1 transition-transform">
            ...
            <div className="min-w-0">
              <div className="font-bold text-slate-900 text-sm lg:text-lg mb-1">
                여성 패션 쇼핑몰
              </div>
              <div className="text-[10px] lg:text-sm bg-rose-50 px-2 lg:px-3 py-1 rounded-full text-rose-600 font-bold inline-block whitespace-normal break-words leading-snug">
                "언니, 이거 좀 핏하게 나왔어요!"
              </div>
            </div>
          </div>
          <div className="w-full max-w-sm bg-white rounded-2xl shadow-lg border border-slate-100 p-4 lg:p-6 flex items-start sm:items-center gap-4 lg:gap-6 transform lg:-translate-x-6 hover:-translate-y-1 transition-transform">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[10px] lg:text-sm bg-blue-50 px-2 lg:px-3 py-1 rounded-full text-blue-600 font-bold inline-block whitespace-normal break-words leading-snug">
                "고객님, 해당 모델은 220V 전용입니다."
              </div>
            </div>
          </div>
        </div>
  ...
  },
  {
    ...
    content: (
      <div
        className={`flex flex-col max-w-5xl mx-auto px-6 justify-center items-center text-center ${slideViewportClass}`}
      >
        <span className="text-xs sm:text-sm uppercase tracking-[0.3em] font-bold text-indigo-400 mb-3 sm:mb-6 block sm:whitespace-nowrap">
          08 / Easy Setup
        </span>
        ...
        <div className="bg-slate-800/80 backdrop-blur border border-slate-700 p-4 sm:p-8 rounded-[20px] w-full max-w-3xl mb-6 sm:mb-10 shadow-2xl relative overflow-hidden z-10 mx-auto">
          <div className="absolute top-0 right-0 p-4 opacity-10 pointer-events-none">
            <Code className="w-12 h-12 sm:w-24 sm:h-24 text-white" />
          </div>
        ...
        <p className="text-sm sm:text-xl lg:text-2xl text-slate-300 font-light max-w-2xl break-keep">
          지금 쓰는 호스팅 어디에든 호환됩니다. 스크립트 코드 하나만 사이트
          하단에 붙여넣으면 즉시 우리 쇼핑몰 전용 AI가 출근합니다.
        </p>
      </div>
    ),
  },
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
          <StatCard
            value="↓ 70%"
            label="단순 문의 감소"
            desc="사이즈·배송·재입고 같은 반복 질문, AI가 즉시 해결해 CS 부담을 확 줄여줍니다."
          />
          <StatCard
            value="↑ 23%"
            label="결제 전환율 상승"
            desc="구매를 망설이는 그 순간, 즉각 답변으로 이탈을 막고 결제까지 이끕니다."
          />
          <StatCard
            value="24/7"
            label="무인 영업 사원"
            desc="밤늦게나 주말에 몰리는 예비 고객들을 절대로 놓치지 않고 응대합니다."
          />
        </div>
        <p className="text-[10px] sm:text-xs text-slate-400 text-center mt-6 sm:mt-10">
          * AI 챗봇 도입 이커머스 업계 평균 수치 (Glassix 2024, Forrester
          Research)
        </p>
      </div>
    ),
...
function StatCard({
  ...
  return (
    <div className="flex flex-col items-center text-center p-4 sm:p-8">
      <div className="text-5xl sm:text-7xl font-black text-indigo-600 mb-2 sm:mb-4 tracking-tighter">
        {value}
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-6 sm:bottom-8 left-0 w-full px-6 sm:px-10 flex items-center justify-between z-50 pointer-events-none">
        <div
          className={`text-[10px] sm:text-sm font-bold tracking-widest hidden xs:block ${slide.theme === "dark" ? "text-slate-500" : "text-slate-400"}`}
        >
          PAVY.AI SALES DECK
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4 pointer-events-auto mx-auto xs:mx-0">
          ...
          <div
            className={`text-xs sm:text-base font-bold tracking-widest px-2 sm:px-4 ${slide.theme === "dark" ? "text-slate-400" : "text-slate-500"}`}
          >
